...
class CLI:
    ...
    def mostrar_menu(self):
        ...
        print("4) Agregar especialidad médico")
    ...
    def agregar_paciente(self):
        try:
            dni = input("DNI: ").strip()
            if not dni:
                print("Error: campo dni debe estar completo")
                return
            nombre = input("Nombre Completo: ").strip()
            if not nombre:
                print("Error: campo nombre debe estar completo")
                return
            fecha = input("Fecha nacimiento (DD/MM/AAAA): ").strip()
            if not fecha:
                print("Error: campo fecha debe estar completo")
                return
    ...
    def agregar_medico(self):
        try:
            ...
            if not matricula:
                print("Error: campo matricula debe estar completo")
                return
            ...
            if not especialidad:    
                print("Error: campo especialidad debe estar completo")
                return
